...
class ranking_model(nn.Module):
    def __init__(self, in_dim, out_dim):
        ...
        self.linear0 = nn.Linear(in_dim, in_dim)
    ...
    def vector_encode(self, vector):
        after_linear0 = self.linear0(vector)
        after_linear0 = torch.relu(after_linear0)
        after_linear1 = self.linear1(after_linear0)
        after_linear1 = torch.relu(after_linear1)
        after_linear2 = self.linear2(after_linear1)
